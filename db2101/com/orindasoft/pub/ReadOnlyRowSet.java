  ...
  public ReadOnlyRowSet(ResultSet theResultSet
    ...
    try
      ...
      try {
		...
		// DB2 standards compliance - calling next(0 repeatedly leads to an Exception...
	}
  ...
  protected Object unloadObject(ResultSet theResultSet, int columnId, int oracleUnderlyingDatatype, boolean keepFiles)
    ...
    try
      ...
      switch (oracleUnderlyingDatatype)
        ...
        // In Oracle this would be handled below; for DB2 we assume getBytes will work...
        ...
        case SqlUtils.ORACLE_BFILE_DATATYPE:
          ...
          if (useByteArraysForLongsAndLOBS)
            ...
            if (   columnOracleDatatypeNames[columnId].equals("LONG"))
              ...
              {
              java.sql.Clob tempClob = theResultSet.getClob(1+columnId);
              if (tempClob != null)
                {
                if (keepLobs)
                  {
                  ...
                  {
                  //newObject = objectUnloader.unloadBinaryStreamIntoByteArray(tempClob.getBinaryStream(),columnOracleDatatypeNames[columnId]);
              ...
              {
              Blob tempBlob = theResultSet.getBlob(1+columnId);
              if (tempBlob != null)
                {
                if (keepLobs)
                  {
                  ...
                  {
                  newObject = objectUnloader.unloadBinaryStreamIntoByteArray(tempBlob.getBinaryStream(),columnOracleDatatypeNames[columnId]);
                  }
                }
              }
//            else if (columnOracleDatatypeNames[columnId].equals("BFILE"))
//              {
//              oracle.sql.BFILE tempBFILE = theResultSet.getBFILE(1+columnId);
//              if (tempBFILE != null)
//                {
//                if (keepLobs)
//                  {
...
//              }
            ...
            if (   columnOracleDatatypeNames[columnId].equals("LONG"))
              ...
              {
              java.sql.Blob tempBlob = theResultSet.getBlob(1+columnId);
              if (tempBlob != null)
                {
                if (keepLobs)
                  {
                  ...
                  {
                  newObject = objectUnloader.unloadBinaryStream(newFile,tempBlob.getBinaryStream(),columnOracleDatatypeNames[columnId]);
                  }
                }
              }
//            else if (columnOracleDatatypeNames[columnId].equals("BFILE"))
...
//              }
        ...
        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:
          {                                                                                  //NOTIN8NY
          newObject = theResultSet.getTimestamp(1+columnId);  //NOTIN8NY
          break;                                                                             //NOTIN8NY
          }                                                                                  //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:
//          {                                                                                  //NOTIN8NY
//          newObject = theResultSet.getTimestampTZ(1+columnId);//NOTIN8NY
//          break;                                                                             //NOTIN8NY
//          }                                                                                  //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:
//          {                                                                                   //NOTIN8NY
//          newObject = theResultSet.getTimestampLTZ(1+columnId);//NOTIN8NY
//          break;                                                                              //NOTIN8NY
//          }                                                                                   //NOTIN8NY
        case SqlUtils.ORACLE_NULL_DATATYPE:
          {                                                                                   //NOTIN8NY
          newObject = null;                                                                   //NOTIN8NY
          break;                                                                              //NOTIN8NY
          }                                                                                   //NOTIN8NY
        ...
        case SqlUtils.ORACLE_INTERVAL_YEAR_TO_MONTH_DATATYPE:
          {                                                             //NOTIN8NY
           // We don't have to do anything special to this value.       //NOTIN8NY
           newObject = theResultSet.getObject(1+columnId);              //NOTIN8NY
           break;                                                       //NOTIN8NY
           }                                                            //NOTIN8NY
        case SqlUtils.ORACLE_OTHER_DATATYPE:                                //NOTIN8NY     
          {                                                             //NOTIN8NY
            // Some 'other' types we like...    //NOTIN8NY
            // Note that we fall thrpugh tpo default: if we dont match       //NOTIN8NY
        	  if (   columnOracleDatatypeNames[columnId].equals("SYS.XMLTYPE")//NOTIN8NY
        		  || columnOracleDatatypeNames[columnId].endsWith(".SDO_GEOMETRY"))//NOTIN8NY
        	  {//NOTIN8NY
              newObject = theResultSet.getObject(1+columnId);              //NOTIN8NY
              break;                                                       //NOTIN8NY
              }    //NOTIN8NY
  ...
  private java.sql.Date getDate
    ...
    if (tempObject == null)
      ...
      switch (oracleUnderlyingDatatype)
        ...
        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:
          {                                                                 //NOTIN8NY
          tempDate = convertTimestampToDate(tempObject, theTimestampFormat); //NOTIN8NY
          break;                                                             //NOTIN8NY
          }                                                                  //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:
//          {                                                                   //NOTIN8NY
//          tempDate = convertTIMESTAMPTZToDate(tempObject, theTimestampFormat); //NOTIN8NY
//          break;                                                               //NOTIN8NY
//          }                                                                    //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:
//          {                                                                    //NOTIN8NY
//          tempDate = convertTIMESTAMPLTZToDate(tempObject, theTimestampFormat);//NOTIN8NY
//          break;                                                               //NOTIN8NY
//          }                                                                    //NOTIN8NY
        case SqlUtils.ORACLE_TEXT_DATATYPE:
        case SqlUtils.ORACLE_NUMBER_DATATYPE:
...
//        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:
//          {                                                                          //NOTIN8NY
//          tempDate = convertTIMESTAMPToTimestamp(tempObject,theTimestampFormat);     //NOTIN8NY
//          break;                                                                     //NOTIN8NY
//          }                                                                          //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:
//          {                                                                          //NOTIN8NY
//          tempDate = convertTIMESTAMPTZToTimestamp(tempObject,theTimestampFormat);   //NOTIN8NY
//          break;                                                                     //NOTIN8NY
//          }                                                                          //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:
//          {                                                                           //NOTIN8NY
//          tempDate = convertTIMESTAMPLTZToTimestamp(tempObject,theTimestampFormat);  //NOTIN8NY
//          break;                                                                      //NOTIN8NY
//          }                                                                          //NOTIN8NY
        case SqlUtils.ORACLE_TEXT_DATATYPE:
        case SqlUtils.ORACLE_NUMBER_DATATYPE:
 ...
 /**                                                                                                                                     //NOTIN8NY
  * Get column <tt>columnId</tt> as a TIMESTAMP.                                                                                        //NOTIN8NY
  *                                                                                                                          //NOTIN8NY
  * This method handles TIMESTAMP data returned by stored procedure calls                                              //NOTIN8NY
  * @since Oracle 9i                                                                   //NOTIN8NY
  * @param int oracleUnderlyingDatatype Identifies what kind of data we are dealing with.                                    //NOTIN8NY
  * @param String oracleDataType The oracle data type of the column                                                          //NOTIN8NY
  * @param String oracleColumnName The name of the column.                                                                   //NOTIN8NY
  * @param Object tempValue An Object that presumably contains a java.sql.Date                                               //NOTIN8NY
  * @return an java.sql.Timestamp.                                                                                         //NOTIN8NY
  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a TIMESTAMP          //NOTIN8NY
  */                                                                                                                         //NOTIN8NY
  private java.sql.Timestamp getTimestamp(int oracleUnderlyingDatatype                                                     //NOTIN8NY
                                           ,String oracleDataType                                                            //NOTIN8NY
                                           ,String oracleColumnName                                                          //NOTIN8NY
                                           ,Object tempValue) throws CSDBInvalidDatatypeCastException                       //NOTIN8NY
    {                                                                           //NOTIN8NY
    java.sql.Timestamp newTIMESTAMP = null;                                   //NOTIN8NY
                                                                                //NOTIN8NY
    if (tempValue != null)                                                      //NOTIN8NY
      {                                                                         //NOTIN8NY
      switch (oracleUnderlyingDatatype)                                         //NOTIN8NY
        {                                                                       //NOTIN8NY
        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:                                //NOTIN8NY
          {                                                                     //NOTIN8NY
          newTIMESTAMP = (java.sql.Timestamp)tempValue;                       //NOTIN8NY
          break;                                                                //NOTIN8NY
          }                                                                     //NOTIN8NY
        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:                             //NOTIN8NY
        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:                              //NOTIN8NY
        case SqlUtils.ORACLE_TEXT_DATATYPE:                                     //NOTIN8NY
        case SqlUtils.ORACLE_NUMBER_DATATYPE:                                   //NOTIN8NY
        case SqlUtils.ORACLE_DATE_DATATYPE:                                     //NOTIN8NY
        case SqlUtils.ORACLE_LONGTEXT_DATATYPE:                                 //NOTIN8NY
        case SqlUtils.ORACLE_BINARY_DATATYPE:                                   //NOTIN8NY
        case SqlUtils.ORACLE_LONG_BINARY_DATATYPE:                              //NOTIN8NY
        case SqlUtils.ORACLE_REFCURSOR_DATATYPE:                                //NOTIN8NY
        case SqlUtils.ORINDASOFT_READONLYROWSET:                                //NOTIN8NY
        case SqlUtils.ORACLE_OBJECT_DATATYPE:                                   //NOTIN8NY
        case SqlUtils.ORACLE_TABLE_DATATYPE:                                    //NOTIN8NY
        case SqlUtils.ORACLE_VARRAY_DATATYPE:                                   //NOTIN8NY
        default:                                                                //NOTIN8NY
          {                                                                                 //NOTIN8NY
          createInvalidDatatypeCastException(oracleDataType,"TIMESTAMP",oracleColumnName);  //NOTIN8NY
          break;                                                                            //NOTIN8NY
          }                                                                                 //NOTIN8NY
        }                                                                                   //NOTIN8NY
      }                                                                                     //NOTIN8NY
                                                                                            //NOTIN8NY
    return (newTIMESTAMP);                                                                  //NOTIN8NY
    }                                                                                                                                                        //NOTIN8NY
                                                                                                                                                             //NOTIN8NY
// /**                                                                                                                                                         //NOTIN8NY
//  * Get column <tt>columnId</tt> as a java.sql.TimestampTZ Object                                                                                          //NOTIN8NY
//  *                                                                                                                                                          //NOTIN8NY
//  * @param String theColumnName The name of the column                                                                                                       //NOTIN8NY
//  * @return an java.sql.TimestampTZ.                                                                                                                       //NOTIN8NY
//  * @throws CSInvalidColumnIdException if columnId is not of a data type that we can handle.                                                                 //NOTIN8NY
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a TIMESTAMPTZ                                        //NOTIN8NY
//  * @throws CSNoDataInRowSetException if there are no rows in this rowset.                                                                                   //NOTIN8NY
//  */                                                                                                                                                         //NOTIN8NY
//  public java.sql.TimestampTZ getTimestampTZ(String theColumnName) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException   //NOTIN8NY
//    {                                                                                                                                                        //NOTIN8NY
//    return (getTimestampTZ(getColumnId(theColumnName)));                                                                                                     //NOTIN8NY
//    }                                                                                                                                                        //NOTIN8NY
//                                                                                                                                                             //NOTIN8NY
// /**                                                                                                                                                         //NOTIN8NY
//  * Get column <tt>columnId</tt> as a TIMESTAMPTZ Object                                                                                                     //NOTIN8NY
//  * @param int columnId The number of the column.                                                                                                            //NOTIN8NY
//  * @return an java.sql.TimestampTZ.                                                                                                                       //NOTIN8NY
//  * @throws CSInvalidColumnIdException if columnId is not of a data type that we can handle.                                                                 //NOTIN8NY
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a TIMESTAMPTZ                                        //NOTIN8NY
//  * @throws CSNoDataInRowSetException if there are no rows in this rowset.                                                                                   //NOTIN8NY
//  */                                                                                                                                                         //NOTIN8NY
//  public java.sql.TimestampTZ getTimestampTZ(int columnId) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException  //NOTIN8NY
//    {                                                                                                                               //NOTIN8NY
//    Object[] tempRow = getCurrentRow();                                                                                             //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    // Will throw CSNoDataInRowSetException if no rows exist.                                                                       //NOTIN8NY
//    checkRows();                                                                                                                    //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    // Will throw CSInvalidColumnIdException if columnId is out of range.                                                           //NOTIN8NY
//    checkRange(columnId);                                                                                                           //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    // will throw CSUnsupportedDatatypeException if currentRow(columnId) can not be turned into a String                            //NOTIN8NY
//    return(getTimestampTZ (underlyingOracleDatatypes[columnId]                                                                      //NOTIN8NY
//                        ,columnOracleDatatypeNames[columnId]                                                                        //NOTIN8NY
//                        ,columnNames[columnId]                                                                                      //NOTIN8NY
//                        ,tempRow[columnId]));                                                                                       //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    }                                                                                                                               //NOTIN8NY
// /**                                                                                                                                //NOTIN8NY
//  * Get column <tt>columnId</tt> as a TIMESTAMPTZ.                                                                                  //NOTIN8NY
//  *                                                                                                                                 //NOTIN8NY
//  * This method handles TIMESTAMPTZ data returned by stored procedure calls                                                         //NOTIN8NY
//  * @since Oracle 9i                                                                   //NOTIN8NY
//  * @param int oracleUnderlyingDatatype Identifies what kind of data we are dealing with.                                           //NOTIN8NY
//  * @param String oracleDataType The oracle data type of the column                                                                 //NOTIN8NY
//  * @param String oracleColumnName The name of the column.                                                                          //NOTIN8NY
//  * @param Object tempValue An Object that presumably contains a java.sql.TimestampLTZ                                            //NOTIN8NY
//  * @return an java.sql.TimestampTZ.                                                                                              //NOTIN8NY
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a String                    //NOTIN8NY
//  */                                                                                                                                //NOTIN8NY
//  private java.sql.TimestampTZ getTimestampTZ(int oracleUnderlyingDatatype                                                        //NOTIN8NY
//                                           ,String oracleDataType                                                                   //NOTIN8NY
//                                           ,String oracleColumnName                                                                 //NOTIN8NY
//                                           ,Object tempValue) throws CSDBInvalidDatatypeCastException                               //NOTIN8NY
//    {                                                                                                                               //NOTIN8NY
//    java.sql.TimestampTZ newTIMESTAMPTZ = null;                                                                                   //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    if (tempValue != null)                                                                                                          //NOTIN8NY
//      {                                                                                                                             //NOTIN8NY
//      switch (oracleUnderlyingDatatype)                                                                                             //NOTIN8NY
...
//        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:                                                                                  //NOTIN8NY
//          {                                                                                                                         //NOTIN8NY
//          newTIMESTAMPTZ = (java.sql.TimestampTZ)tempValue;                                                                       //NOTIN8NY
//          break;                                                                                                                    //NOTIN8NY
//          }                                                                                                                         //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:                                                                                    //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:                                                                                 //NOTIN8NY
...
//        default:                                                                                                                    //NOTIN8NY
//          {                                                                                                                         //NOTIN8NY
//          createInvalidDatatypeCastException(oracleDataType,"TIMESTAMPTZ",oracleColumnName);                                        //NOTIN8NY
//          break;                                                                                                                    //NOTIN8NY
//          }                                                                                                                         //NOTIN8NY
//        }                                                                                                                           //NOTIN8NY
//      }                                                                                                                             //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    return (newTIMESTAMPTZ);                                                                                                        //NOTIN8NY
//    }                                                                                                                               //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//  /**                                                                                                                               //NOTIN8NY
//  * Get column <tt>columnId</tt> as a java.sql.TimestampLTZ Object                                                                //NOTIN8NY
//  *                                                                                                                                 //NOTIN8NY
//  * @param String theColumnName The name of the column                                                                              //NOTIN8NY
//  * @return an java.sql.TimestampLTZ.                                                                                             //NOTIN8NY
//  * @throws CSInvalidColumnIdException if columnId is not of a data type that we can handle.                                        //NOTIN8NY
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a TIMESTAMPLTZ              //NOTIN8NY
//  * @throws CSNoDataInRowSetException if there are no rows in this rowset.                                                          //NOTIN8NY
//  */                                                                                                                                //NOTIN8NY
//  public java.sql.TimestampLTZ getTimestampLTZ(String theColumnName) throws CSInvalidColumnIdException, CSNoDataInRowSetException,//NOTIN8NY
// CSDBInvalidDatatypeCastException {                                                                                                 //NOTIN8NY
//    return (getTimestampLTZ(getColumnId(theColumnName)));                                                                           //NOTIN8NY
//    }                                                                                                                               //NOTIN8NY
// /**                                                                                                                                //NOTIN8NY
//  * Get column <tt>columnId</tt> as a TIMESTAMPLTZ Object                                                                           //NOTIN8NY
//  * @param int columnId The number of the column.                                                                                   //NOTIN8NY
//  * @return an java.sql.TimestampLTZ.                                                                                             //NOTIN8NY
//  * @throws CSInvalidColumnIdException if columnId is not of a data type that we can handle.                                        //NOTIN8NY
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a TIMESTAMPLTZ              //NOTIN8NY
//  * or the column is a number that is too big too fit into a TIMESTAMPLTZ.                                                          //NOTIN8NY
//  * @throws CSNoDataInRowSetException if there are no rows in this rowset.                                                          //NOTIN8NY
//  */                                                                                                                                //NOTIN8NY
//  public java.sql.TimestampLTZ getTimestampLTZ(int columnId) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException   //NOTIN8NY
//    {                                                                                                                                                           //NOTIN8NY
//    Object[] tempRow = getCurrentRow();                                                                                             //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    // Will throw CSNoDataInRowSetException if no rows exist.                                                                       //NOTIN8NY
...
//                                                                                                                                    //NOTIN8NY
//    // will throw CSUnsupportedDatatypeException if currentRow(columnId) can not be turned into a String                            //NOTIN8NY
//    return(getTimestampLTZ (underlyingOracleDatatypes[columnId]                                                                     //NOTIN8NY
//                        ,columnOracleDatatypeNames[columnId]                                                                        //NOTIN8NY
//                        ,columnNames[columnId]                                                                                      //NOTIN8NY
//                        ,tempRow[columnId]));                                                                                       //NOTIN8NY
//                                                                                                                                    //NOTIN8NY
//    }                                                                                                                               //NOTIN8NY
// /**                                                                                                                                //NOTIN8NY
//  * Get column <tt>columnId</tt> as a TIMESTAMPLTZ.                                                                                 //NOTIN8NY
//  *                                                                                                                                 //NOTIN8NY
//  * This method handles TIMESTAMPLTZ data returned by stored procedure calls                                                        //NOTIN8NY
//  * @since Oracle 9i                                                                   //NOTIN8NY
//  * @param int oracleUnderlyingDatatype Identifies what kind of data we are dealing with.                                           //NOTIN8NY
//  * @param String oracleDataType The oracle data type of the column                                                                 //NOTIN8NY
//  * @param String oracleColumnName The name of the column.                                                                          //NOTIN8NY
//  * @param Object tempValue An Object that presumably contains a java.sql.TimestampLTZ                                            //NOTIN8NY
//  * @return an java.sql.TimestampLTZ.                                                                                             //NOTIN8NY
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a java.sql.TimestampLTZ   //NOTIN8NY
//  */                                                                                                                                //NOTIN8NY
//  private java.sql.TimestampLTZ getTimestampLTZ(int oracleUnderlyingDatatype                                                      //NOTIN8NY
//                                           ,String oracleDataType                                                                   //NOTIN8NY
//                                           ,String oracleColumnName                                                                 //NOTIN8NY
//                                           ,Object tempValue) throws CSDBInvalidDatatypeCastException                               //NOTIN8NY
//    {                                                                                                                               //NOTIN8NY
//    java.sql.TimestampLTZ newTIMESTAMPLTZ = null;                                               //NOTIN8NY
//                                                                                                  //NOTIN8NY
//    if (tempValue == null)                                                                        //NOTIN8NY
//      {                                                                                           //NOTIN8NY
//      newTIMESTAMPLTZ = null;                                                                     //NOTIN8NY
//      }                                                                                           //NOTIN8NY
//    else                                                                                          //NOTIN8NY
//      {                                                                                           //NOTIN8NY
//      switch (oracleUnderlyingDatatype)                                                           //NOTIN8NY
...
//        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:                                               //NOTIN8NY
//          {                                                                                       //NOTIN8NY
//          newTIMESTAMPLTZ = (java.sql.TimestampLTZ)tempValue;                                   //NOTIN8NY
//          break;                                                                                  //NOTIN8NY
//          }                                                                                       //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:                                                  //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:                                                //NOTIN8NY
...
//        default:                                                                                  //NOTIN8NY
//          {                                                                                       //NOTIN8NY
//          createInvalidDatatypeCastException(oracleDataType,"TIMESTAMPLTZ",oracleColumnName);     //NOTIN8NY
//          break;                                                                                  //NOTIN8NY
//          }                                                                                       //NOTIN8NY
//        }                                                                                         //NOTIN8NY
//      }                                                                                           //NOTIN8NY
//                                                                                                  //NOTIN8NY
//    return (newTIMESTAMPLTZ);                                                                     //NOTIN8NY
//    }                                                                                             //NOTIN8NY
//                                                                                                  //NOTIN8NY
 /**
  * Get column <tt>columnId</tt> as a boolean.
  ...
  private String getString(int oracleUnderlyingDatatype
    ...
    if (tempValue == null)
      ...
      switch (oracleUnderlyingDatatype)
        ...
        case SqlUtils.ORACLE_TIMESTAMP_DATATYPE:
          {                                                                     //NOTIN8NY
          newString = convertTimestampToString(tempValue, theTimestampFormat);  //NOTIN8NY
          break;                                                                //NOTIN8NY
          }                                                                     //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPTZ_DATATYPE:
//          {                                                                     //NOTIN8NY
//          newString = convertTIMESTAMPTZToString(tempValue, theTimestampFormat);//NOTIN8NY
//          break;                                                                //NOTIN8NY
//          }                                                                     //NOTIN8NY
//        case SqlUtils.ORACLE_TIMESTAMPLTZ_DATATYPE:
//          {                                                                     //NOTIN8NY
//          newString = convertTIMESTAMPLTZToString(tempValue, theTimestampFormat);//NOTIN8NY
//          break;                                                                 //NOTIN8NY
//          }                                                                     //NOTIN8NY
        case SqlUtils.ORACLE_LONGTEXT_DATATYPE:
        case SqlUtils.ORACLE_LONG_BINARY_DATATYPE:
        ...
        case SqlUtils.ORACLE_INTERVAL_DAY_TO_SECOND_DATATYPE:
          {                                                      //NOTIN8NY
          newString = tempValue.toString().trim();               //NOTIN8NY
          break;                                                  //NOTIN8NY
          }                                                       //NOTIN8NY
        case SqlUtils.ORACLE_INTERVAL_YEAR_TO_MONTH_DATATYPE:
          {                                                      //NOTIN8NY
...
//        case SqlUtils.ORACLE_ROWID_DATATYPE:
//          {                                                              //NOTIN8NY
//          newString = ((oracle.sql.ROWID)tempValue).stringValue();       //NOTIN8NY
//          break;                                                          //NOTIN8NY
//          }                                                               //NOTIN8NY
        case SqlUtils.ORACLE_BINARY_DATATYPE:
        case SqlUtils.ORACLE_REFCURSOR_DATATYPE:
...
///**
//  * Get column <tt>columnId</tt> as an java.sql.Opaque.
//  * @param String the name of the column.
//  * @return java.sql.Opaque the Value of column #columnId if it can be turned into an java.sql.Opaque.
//  * @throws CSInvalidColumnIdException if columnId is not the id of a valid column. Column numbering starts at 0.
//  * @throws CSNoDataInRowSetException if there are no rows in this rowset.
//  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be turned into a String.
//  * @throws CSUnsupportedDatatypeException if columnId is not of a data type that we support.
//  */
//   public java.sql.Opaque getOpaque(String theColumnName) throws CSInvalidColumnIdException, CSNoDataInRowSetException,CSDBInvalidDatatypeCastException,CSUnsupportedDatatypeException
//    {
...
//  * @throws CSUnsupportedDatatypeException if columnId is not of a data type that we support.
//  */
//   public java.sql.Opaque getOpaque(int columnId) throws CSInvalidColumnIdException, CSNoDataInRowSetException,CSDBInvalidDatatypeCastException,CSUnsupportedDatatypeException
//    {
//    Object[] tempRow = getCurrentRow();
//
//    // Will throw CSNoDataInRowSetException if no rows exist.
...
//    checkRange(columnId);
//
//    return((java.sql.Opaque)tempRow[columnId]);
//    }
...
//  /**                                                                                                               //NOTIN8NY
//  * Utility method that will try to turn theTIMESTAMPObject into a java.sql.Timestamp object and then a String.   //NOTIN8NY
//  * @param Object An object which is supposed to be an instance of java.sql.Timestamp                             //NOTIN8NY
//  * @param SimpleDateFormat theTimestampFormat The date/time format we are using.                                   //NOTIN8NY
//  * @see com.orindasoft.pub.LogInterface.DEFAULT_TIME_FORMAT_STRING                                                 //NOTIN8NY
//  * @see java.sql.Date                                                                                              //NOTIN8NY
//  * @see java.sql.Timestamp                                                                                         //NOTIN8NY
//  * @see java.sql.Timestamp                                                                                       //NOTIN8NY
//  * @return String A date formated into a string.                                                                   //NOTIN8NY
//  */                                                                                                                //NOTIN8NY
//  protected String convertTIMESTAMPToString(Object theTIMESTAMPObject, SimpleDateFormat theTimestampFormat)         //NOTIN8NY
//    {                                                                                                               //NOTIN8NY
//    String newString = "";                                                                                          //NOTIN8NY
//                                                                                                                    //NOTIN8NY
//    if (theTIMESTAMPObject == null)                                                                                 //NOTIN8NY
//      {                                                                                                             //NOTIN8NY
//      newString = "";                                                                                               //NOTIN8NY
//      }                                                                                                             //NOTIN8NY
//    else                                                                                                            //NOTIN8NY
...
//       try                                                                                                          //NOTIN8NY
//         {                                                                                                          //NOTIN8NY
//         // This will throw a nullpointer exception if tempValue is a valid but empty java.sql.Timestamp          //NOTIN8NY
//         Timestamp tempStamp = ((java.sql.Timestamp)theTIMESTAMPObject).timestampValue();                         //NOTIN8NY
//         newString = convertTimestampToString(tempStamp, theTimestampFormat);                                       //NOTIN8NY
//         }                                                                                                          //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                                                     //NOTIN8NY
//         {                                                                                                          //NOTIN8NY
//         // A null timestamp column shows up as an empty timestamp object.....                                      //NOTIN8NY
//         newString = "";                                                                                            //NOTIN8NY
//         }                                                                                                          //NOTIN8NY
//       catch (SQLException e)                                                                                       //NOTIN8NY
//         {                                                                                                          //NOTIN8NY
//         theLog.error(e);                                                                                           //NOTIN8NY
//         newString = "";                                                                                            //NOTIN8NY
//         }                                                                                                          //NOTIN8NY
//      }                                                                                                             //NOTIN8NY
//                                                                                                                    //NOTIN8NY
//    return(newString);                                                                                              //NOTIN8NY
//    }                                                                                                               //NOTIN8NY
//                                                                                                                    //NOTIN8NY
  /**                                                                                                               //NOTIN8NY
  * Utility method that will try to turn theTIMESTAMPObject into a Date object.                                     //NOTIN8NY
  * @param Object An object which is supposed to be an instance of java.sql.Timestamp                             //NOTIN8NY
  * @param SimpleDateFormat theTimestampFormat The date/time format we are using.                                   //NOTIN8NY
  * @see com.orindasoft.pub.LogInterface.DEFAULT_TIME_FORMAT_STRING                                                 //NOTIN8NY
  * @see java.sql.Date                                                                                              //NOTIN8NY
  * @see java.sql.Timestamp                                                                                         //NOTIN8NY
  * @see java.sql.Timestamp                                                                                       //NOTIN8NY
  * @return Date A date.                                                                                            //NOTIN8NY
  */                                                                                                                //NOTIN8NY
  protected java.sql.Date convertTimestampToDate(Object theTIMESTAMPObject, SimpleDateFormat theTimestampFormat)    //NOTIN8NY
    {                                                                                                               //NOTIN8NY
    Date newDate = null;                                                                                           //NOTIN8NY
                                                                                                                   //NOTIN8NY
    if (theTIMESTAMPObject != null)                                                                               //NOTIN8NY
      {                                                                                                           //NOTIN8NY
      newDate =  (java.sql.Date)theTIMESTAMPObject;                                                  //NOTIN8NY                                                                                                           //NOTIN8NY
      }                                                                                                       //NOTIN8NY
                                                                                                              //NOTIN8NY
    return(newDate);                                                                                          //NOTIN8NY
    }                                                                                                         //NOTIN8NY
                                                                                                              //NOTIN8NY
//  /**                                                                                                         //NOTIN8NY
//  * Utility method that will try to turn theTIMESTAMPObject into a Date object.                               //NOTIN8NY
...
//  * @return Date A date.                                                                                      //NOTIN8NY
//  */                                                                                                          //NOTIN8NY
//  protected java.sql.Timestamp convertTIMESTAMPToTimestamp(Object theTIMESTAMPObject, SimpleDateFormat theTimestampFormat) //NOTIN8NY
//    {                                                                                                         //NOTIN8NY
//    Timestamp newDate = null;                                                                                 //NOTIN8NY
//                                                                                                              //NOTIN8NY
//    if (theTIMESTAMPObject == null)                                                                           //NOTIN8NY
//      {                                                                                                       //NOTIN8NY
//      newDate = null;                                                                                         //NOTIN8NY
//      }                                                                                                       //NOTIN8NY
//    else                                                                                                      //NOTIN8NY
//      {                                                                                                       //NOTIN8NY
//       try                                                                                                    //NOTIN8NY
//         {                                                                                                    //NOTIN8NY
//         // This will throw a nullpointer exception if tempValue is a valid but empty java.sql.Timestamp    //NOTIN8NY
//         newDate = ((java.sql.Timestamp)theTIMESTAMPObject).timestampValue();                               //NOTIN8NY
//         }                                                                                                    //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                                               //NOTIN8NY
//         {                                                                                                    //NOTIN8NY
//         // A null timestamp column shows up as an empty timestamp object.....                                //NOTIN8NY
...
//  * @return Date A date.                                                                                      //NOTIN8NY
//  */                                                                                                          //NOTIN8NY
//  protected java.sql.Timestamp convertTIMESTAMPTZToTimestamp(Object theTIMESTAMPTZObject, SimpleDateFormat theTimestampFormat) //NOTIN8NY
//    {                                                                                                         //NOTIN8NY
//    Timestamp newTimestamp = null;                                                                            //NOTIN8NY
//                                                                                                              //NOTIN8NY
//    if (theTIMESTAMPTZObject == null)                                                                         //NOTIN8NY
//      {                                                                                                       //NOTIN8NY
//      newTimestamp = null;                                                                                    //NOTIN8NY
//      }                                                                                                       //NOTIN8NY
//    else                                                                                                      //NOTIN8NY
//      {                                                                                                       //NOTIN8NY
//       try                                                                                                    //NOTIN8NY
//         {                                                                                                    //NOTIN8NY
//         if (((java.sql.TimestampTZ)theTIMESTAMPTZObject).getLength() > 0)                                   //NOTIN8NY
//           {                                                                                                     //NOTIN8NY
//           oracle.sql.DATE tempDate = new oracle.sql.DATE(((java.sql.TimestampTZ)theTIMESTAMPTZObject).getBytes()); //NOTIN8NY
//           newTimestamp = tempDate.timestampValue();                                                                //NOTIN8NY
//           }                                                                                                      //NOTIN8NY
//         }                                                                                                      //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                                                //NOTIN8NY
//         {                                                                                                    //NOTIN8NY
...
//  * @return Date A date.                                                                   //NOTIN8NY
//  */                                                                                        //NOTIN8NY
//  protected java.sql.Timestamp convertTIMESTAMPLTZToTimestamp(Object theTIMESTAMPLTZObject, SimpleDateFormat theTimestampFormat) //NOTIN8NY
//    {                                                                                        //NOTIN8NY
//    Timestamp newTimestamp = null;                                                           //NOTIN8NY
//                                                                                             //NOTIN8NY
//    if (theTIMESTAMPLTZObject == null)                                                       //NOTIN8NY
//      {                                                                                      //NOTIN8NY
//      newTimestamp = null;                                                                   //NOTIN8NY
//      }                                                                                      //NOTIN8NY
//    else                                                                                     //NOTIN8NY
...
//       try                                                                                   //NOTIN8NY
//         {                                                                                   //NOTIN8NY
//         if (((java.sql.TimestampLTZ)theTIMESTAMPLTZObject).getLength() > 0)               //NOTIN8NY
//           {                                                                                 //NOTIN8NY
//           oracle.sql.DATE tempDate = new oracle.sql.DATE(((java.sql.TimestampLTZ)theTIMESTAMPLTZObject).getBytes()); //NOTIN8NY
//           newTimestamp = tempDate.timestampValue();                                         //NOTIN8NY
//           }                                                                                  //NOTIN8NY
//         }                                                                                    //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                               //NOTIN8NY
...
//  * @return Date A date.                                                                                                 //NOTIN8NY
//  */                                                                                                                     //NOTIN8NY
//  protected java.sql.Date convertTIMESTAMPLTZToDate(Object theTIMESTAMPLTZObject, SimpleDateFormat theTimestampFormat)   //NOTIN8NY
//    {                                                                                                                    //NOTIN8NY
//    java.sql.Date newDate = null;                                                                                        //NOTIN8NY
//                                                                                                                         //NOTIN8NY
//    if (theTIMESTAMPLTZObject == null)                                                                                   //NOTIN8NY
//      {                                                                                                                  //NOTIN8NY
//      newDate = null;                                                                                                    //NOTIN8NY
...
//         if (((java.sql.TimestampLTZ)theTIMESTAMPLTZObject).getLength() > 0)                                           //NOTIN8NY
//           {                                                                                                             //NOTIN8NY
//           Timestamp tempTimeStamp = convertTIMESTAMPLTZToTimestamp(theTIMESTAMPLTZObject, theTimestampFormat);          //NOTIN8NY
//           newDate = new java.sql.Date(tempTimeStamp.getTime());                                                         //NOTIN8NY
//           }                                                                                                             //NOTIN8NY
//         }                                                                                                               //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                                                          //NOTIN8NY
//         {                                                                                                               //NOTIN8NY
...
//                                                                                                                         //NOTIN8NY
//  /**                                                                                                                    //NOTIN8NY
//  * Utility method that will try to turn theTIMESTAMPTZObject into a java.sql.TimestampTZ object and then a String.    //NOTIN8NY
//  * @param Object An object which is supposed to be an instance of java.sql.TimestampTZ                                //NOTIN8NY
//  * @param SimpleDateFormat theTimestampFormat The date/time format we are using.                                        //NOTIN8NY
//  * @see com.orindasoft.pub.LogInterface.DEFAULT_TIME_FORMAT_STRING                                                      //NOTIN8NY
//  * @see java.sql.Date                                                                                                   //NOTIN8NY
//  * @see java.sql.Timestamp                                                                                              //NOTIN8NY
//  * @see java.sql.TimestampTZ                                                                                          //NOTIN8NY
//  * @return String A date formated into a string.                                                                        //NOTIN8NY
//  */                                                                                                                     //NOTIN8NY
//  protected String convertTIMESTAMPTZToString(Object theTIMESTAMPTZObject, SimpleDateFormat theTimestampFormat)          //NOTIN8NY
//    {                                                                                                                    //NOTIN8NY
//    String newString = "";                                                                                               //NOTIN8NY
//                                                                                                                         //NOTIN8NY
//    if (theTIMESTAMPTZObject == null)                                                                                    //NOTIN8NY
...
//       try                                                                                                               //NOTIN8NY
//         {                                                                                                               //NOTIN8NY
//         // A Null TIMESTAMPTZ column still returns a TIMESTAMPTZ object. getLength() tells us                           //NOTIN8NY
//         // whether it's null or not.                                                                                    //NOTIN8NY
//         if (((java.sql.TimestampTZ)theTIMESTAMPTZObject).getLength() > 0)                                             //NOTIN8NY
//           {                                                                                                             //NOTIN8NY
//           oracle.sql.DATE tempDate = new oracle.sql.DATE(((java.sql.TimestampTZ)theTIMESTAMPTZObject).getBytes());    //NOTIN8NY
//           newString = convertTimestampToString(tempDate.timestampValue(), theTimestampFormat);                          //NOTIN8NY
//           }                                                                                                             //NOTIN8NY
//         }                                                                                                               //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                                                          //NOTIN8NY
//         {                                                                                                               //NOTIN8NY
...
//  * @return String A date formated into a string.                                                                        //NOTIN8NY
//  */                                                                                                                     //NOTIN8NY
//  protected java.sql.Date convertTIMESTAMPTZToDate(Object theTIMESTAMPTZObject, SimpleDateFormat theTimestampFormat)     //NOTIN8NY
//    {                                                                                                                    //NOTIN8NY
//    java.sql.Date newDate = null;                                                                                        //NOTIN8NY
//                                                                                                                         //NOTIN8NY
//    if (theTIMESTAMPTZObject == null)                                                                                    //NOTIN8NY
...
//         if (((java.sql.TimestampTZ)theTIMESTAMPTZObject).getLength() > 0)                                             //NOTIN8NY
//           {                                                                                                             //NOTIN8NY
//           Timestamp tempTimestamp = convertTIMESTAMPTZToTimestamp(theTIMESTAMPTZObject, theTimestampFormat);            //NOTIN8NY
//           newDate = new java.sql.Date(tempTimestamp.getTime());                                                         //NOTIN8NY
//           }                                                                                                             //NOTIN8NY
//         }                                                                                                               //NOTIN8NY
//       catch (java.lang.NullPointerException e)                                                                          //NOTIN8NY
...
//                                                                                                                         //NOTIN8NY
//  /**                                                                                                                    //NOTIN8NY
//  * Utility method that will try to turn theTIMESTAMPLTZObject into a java.sql.TimestampLTZ object and then a String.  //NOTIN8NY
//  * @param Object An object which is supposed to be an instance of java.sql.TimestampLTZ                               //NOTIN8NY
//  * @param SimpleDateFormat theTimestampFormat The date/time format we are using.                                        //NOTIN8NY
//  * @see com.orindasoft.pub.LogInterface.DEFAULT_TIME_FORMAT_STRING                                                      //NOTIN8NY
//  * @see java.sql.Date                                                                                                   //NOTIN8NY
//  * @see java.sql.Timestamp                                                                                              //NOTIN8NY
//  * @see java.sql.TimestampLTZ                                                                                         //NOTIN8NY
//  * @return String A date formated into a string.                                                                        //NOTIN8NY
//  */                                                                                                                     //NOTIN8NY
//  protected String convertTIMESTAMPLTZToString(Object theTIMESTAMPLTZObject, SimpleDateFormat theTimestampFormat)        //NOTIN8NY
//    {                                                                                                                    //NOTIN8NY
//    String newString = "";                                                                                               //NOTIN8NY
//                                                                                                                         //NOTIN8NY
//    if (theTIMESTAMPLTZObject == null)                                                                                   //NOTIN8NY
...
//  }
  ...
  /**
  * Get column <tt>columnId</tt> as a java.sql.Blob Object
  * This method will only work if 'keepLobs' was set to true.
  * @param String theColumnName The name of the column
  * @return java.sql.Blob the Value of column #columnId if it can be turned into a java.sql.Blob.
  * @throws CSInvalidColumnIdException if columnId is not of a data type that we can handle.
  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a java.sql.Blob
  * @throws CSNoDataInRowSetException if there are no rows in this rowset.
  * @since 2.0.1505
  */
  public java.sql.Blob getBlob(String theColumnName) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException
    {
  ...
  * @since 2.0.1505
  */
  public java.sql.Blob getBlob(int columnId) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException
    {
    // Will throw CSNoDataInRowSetException if no rows exist.
    checkRows();
  ...
  /**
  * Get column <tt>columnId</tt> as a java.sql.Blob
  * This method will only work if 'keepLobs' was set to true.
  * @param int oracleUnderlyingDatatype Identifies what kind of data we are dealing with.
  * @param String oracleDataType The oracle data type of the column
  * @param String oracleColumnName The name of the column.
  ...
  */
  ...
  if (tempValue == null)
    ...
    switch (oracleUnderlyingDatatype)
      ...
      case SqlUtils.ORACLE_BLOB_DATATYPE:
        {
        if (tempValue instanceof java.sql.Blob)
          {
          newLob = (java.sql.Blob)tempValue;
          }
        else
          {
          createInvalidDatatypeCastException(oracleDataType,"java.sql.Blob",oracleColumnName);
          }
        break;
        }
      default:
  ...
  /**
  * Get column <tt>columnId</tt> as a java.sql.Clob Object
  * This method will only work if 'keepLobs' was set to true.
  * @param String theColumnName The name of the column
  * @return java.sql.Clob the Value of column #columnId if it can be turned into a java.sql.Clob.
  * @throws CSInvalidColumnIdException if columnId is not of a data type that we can handle.
  * @throws CSDBInvalidDatatypeCastException if columnId is not of a data type that can be converted to a java.sql.Clob
  * @throws CSNoDataInRowSetException if there are no rows in this rowset.
  * @since 2.0.1505
  */
  public java.sql.Clob getClob(String theColumnName) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException
    {
  ...
  * @since 2.0.1505
  */
  public java.sql.Clob getClob(int columnId) throws CSInvalidColumnIdException, CSNoDataInRowSetException, CSDBInvalidDatatypeCastException
    {
    // Will throw CSNoDataInRowSetException if no rows exist.
    checkRows();
  ...
  /**
  * Get column <tt>columnId</tt> as a java.sql.Clob
  * This method will only work if 'keepLobs' was set to true.
  * @param int oracleUnderlyingDatatype Identifies what kind of data we are dealing with.
  * @param String oracleDataType The oracle data type of the column
  * @param String oracleColumnName The name of the column.
  ...
  */
  ...
  if (tempValue == null)
    ...
    switch (oracleUnderlyingDatatype)
      ...
      case SqlUtils.ORACLE_CLOB_DATATYPE:
        {
        if (tempValue instanceof java.sql.Clob)
          {
          newLob = (java.sql.Clob)tempValue;
          }
        else
          {
          createInvalidDatatypeCastException(oracleDataType,"java.sql.Clob",oracleColumnName);
          }
        break;
        }
      default:
