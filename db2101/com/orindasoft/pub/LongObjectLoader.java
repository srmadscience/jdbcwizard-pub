...
* @return java.sql.Clob newCLOB CLOB to be updated
*/
public static java.sql.Clob loadCLOB(java.sql.Clob newCLOB, File theFile, int bufferSize) throws CSException
  {
  // Variables needed to stream the long data from the DB.
  int bytesRead = 0;
  byte[] theBuffer = new byte[bufferSize];
...
* @param java.sql.Blob newBLOB BLOB to be updated
* @param byte[] theArray an array of bytes
* @return java.sql.Blob newBLOB 
*/
public static java.sql.Blob loadBLOB(java.sql.Blob newBLOB, File theFile, int bufferSize) throws CSException
  {
  // Variables needed to stream the long data from the DB.
  int bytesRead = 0;
  byte[] theBuffer = new byte[bufferSize];
...
* @param java.sql.Clob newCLOB CLOB to be updated
* @param byte[] theArray an array of bytes
* @return java.sql.Clob newCLOB 
*/
public static java.sql.Clob loadCLOB(java.sql.Clob newCLOB, byte[] theArray) throws CSException
  {
  // Variables needed to stream the long data from the DB.
  OutputStream outStream = null;
...
*/
public static java.sql.Blob loadBLOB(java.sql.Blob newBLOB, byte[] theArray) throws CSException
  {
  // Variables needed to stream the long data from the DB.
  OutputStream outStream = null;
...
* @param File newFile File to unload stream into
* @param java.sql.Blob tempBLOB BLOB to unload.
*/
public File unloadBlob(File newFile, java.sql.Blob tempBLOB) throws CSException
  {
...
* @param File newFile File to unload stream into
*/
public File unloadClob(File newFile, java.sql.Clob tempCLOB) throws CSException
  {
...
* @since JDBCWizard V5.0.2303
*/
public byte[] unloadBlobIntoByteArray( java.sql.Blob tempBLOB) throws CSException
  {
...
* @since JDBCWizard V5.0.2303
*/
public byte[] unloadClobIntoByteArray( java.sql.Clob tempCLOB) throws CSException
  {
  byte[] newBytes = new byte[0];
  InputStream clobInputStream;
  // See if column was null...
...
* @return java.sql.Clob newCLOB
*/
public static java.sql.Clob loadCLOB(java.sql.Clob newCLOB, char[] theArray) throws CSException
  {
...
public static Object[] unloadObjectArray(Object theArray) throws CSException {
	Object[] newArray = null;
	
	if (theArray != null )
	  {
  	  if (theArray instanceof Object[])
	    {
  		int arraySize = ((Object[])theArray).length;
  		newArray = new Object[arraySize];
  		
  		for (int i=0; i < arraySize; i++ )
  		  {
  		  newArray[i] = ((Object[])theArray)[i];
  		  }	
	    }
	  else
	    {
		throw new CSException("Unable to turn " + theArray.getClass().getName() + " into Object[]");
	    }
      }
	return newArray;
