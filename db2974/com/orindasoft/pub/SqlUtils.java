...
import java.sql.*;
//import oracle.jdbc.OracleTypes; //DRKLUGE
  ...
  */
  public static int getUnderlyingOracleDatatype(String theColumnDataType)
    ...
    if (theColumnDataType == null)
      ...
      returnCode = ORACLE_INTERVAL_DAY_TO_SECOND_DATATYPE;           //NOTIN8NY  //NOTIN920 //NOTIN901
      }                                                              //NOTIN8NY  //NOTIN920 //NOTIN901 
    ...
    else if (   theColumnDataType.startsWith("PL/SQL TABLE"))   //NOTIN8NY  //NOTIN920 //NOTIN901
      {                                                         //NOTIN8NY  //NOTIN920 //NOTIN901
      returnCode = ORACLE_PLSQL_INDEXBY_DATATYPE;               //NOTIN8NY  //NOTIN920 //NOTIN901
      }                                                         //NOTIN8NY  //NOTIN920 //NOTIN901 
    else if (   theColumnDataType.equals("XMLTYPE"))            //NOTIN8NY  //NOTIN920 //NOTIN901
      {                                                        //NOTIN8NY  //NOTIN920 //NOTIN901
      returnCode = ORACLE_XMLTYPE_DATATYPE;                      //NOTIN8NY  //NOTIN920 //NOTIN901
      }                                                        //NOTIN8NY  //NOTIN920 //NOTIN901
    else if (   theColumnDataType.equals("SDO_GEOMETRY"))            //NOTIN8NY  //NOTIN920 //NOTIN901
      {                                                        //NOTIN8NY  //NOTIN920 //NOTIN901
      returnCode = ORACLE_SDO_GEOMETRY_DATATYPE;                      //NOTIN8NY  //NOTIN920 //NOTIN901
      }                                                        //NOTIN8NY  //NOTIN920 //NOTIN901
    ...
    return(returnCode);
                                                                        ...
                                                                        //NOTIN815 //NOTIN816
  /**                                                                    //NOTIN815 //NOTIN816
  * Create and return a BFILE locator.                                   //NOTIN815 //NOTIN816
  * This static method creates an oracle.sql.BFILE object                //NOTIN815 //NOTIN816
  * by accessing the database. Note that a 'valid' BFILE will be          //NOTIN815 //NOTIN816
  * returned even if theOracleDirectory does not exist or theFileName          //NOTIN815 //NOTIN816
  * does not refer to an existing file.                                    //NOTIN815 //NOTIN816
  * @param String theOracleDirectory                                      //NOTIN815 //NOTIN816
  * @param String theFileName                                             //NOTIN815 //NOTIN816
  * @param Connection a database Connection                                //NOTIN815 //NOTIN816
  * @param com.orindasoft.pub.LogInterface a logging mechanism             //NOTIN815 //NOTIN816
  * @param boolean debugMessages Create debug messages in log              //NOTIN815 //NOTIN816
  * @return oracle.sql.BFILE A BFILE which may or may not be usable.        //NOTIN815 //NOTIN816
  * @throws CSException If we can't create a BFILE.                         //NOTIN815 //NOTIN816
  * @since Oracle 8.1.7 / JDBCWizard 4.0.2108                          //NOTIN815 //NOTIN816
  */    
  //NOTIN815 //NOTIN816
  /**
   * // DRKLUGE
  
  public static oracle.sql.BFILE createBfileLocator(String theOracleDirectory   //NOTIN815 //NOTIN816
                                                   ,String theFileName               //NOTIN815 //NOTIN816
                                                   ,java.sql.Connection theConnection   //NOTIN815 //NOTIN816
                                                   ,LogInterface theLog                   //NOTIN815 //NOTIN816
                                                   ,boolean debugMessages) throws CSException   //NOTIN815 //NOTIN816
    {                                                                                           //NOTIN815 //NOTIN816
    oracle.sql.BFILE newBfile = null;                                                            //NOTIN815 //NOTIN816
                                                                                                  //NOTIN815 //NOTIN816
    try                                                                                            //NOTIN815 //NOTIN816
      {                                                                                             //NOTIN815 //NOTIN816
      if (debugMessages)                                                                             //NOTIN815 //NOTIN816
        {                                                                                             //NOTIN815 //NOTIN816
        theLog.debug("IOUtils.createBfileLocator: Attempting to create BFILE locator for Directory/File "  //NOTIN815 //NOTIN816
                    + theOracleDirectory                                                                    //NOTIN815 //NOTIN816
                    + "/"                                                                                   //NOTIN815 //NOTIN816
                    + theFileName );                                                                         //NOTIN815 //NOTIN816
        }                                                                                                    //NOTIN815 //NOTIN816
                                                                                                                   //NOTIN815 //NOTIN816
     // PreparedStatement getBfileStatement = theConnection.prepareStatement("SELECT /* JDBCWizard */ //bfilename(?,?) FROM DUAL");   //NOTIN815 //NOTIN816
     /** getBfileStatement.setString(1,theOracleDirectory);                                                       //NOTIN815 //NOTIN816
      getBfileStatement.setString(2,theFileName);                                                               //NOTIN815 //NOTIN816
      ResultSet theResult = getBfileStatement.executeQuery();                                                   //NOTIN815 //NOTIN816
      theResult.next();                                                                                         //NOTIN815 //NOTIN816
      newBfile = (oracle.sql.BFILE)theResult.getObject(1);                                                       //NOTIN815 //NOTIN816
      theResult.close();                                                                                         //NOTIN815 //NOTIN816
      getBfileStatement.close();                                                                                 //NOTIN815 //NOTIN816
                                                                                                                  //NOTIN815 //NOTIN816
      if (debugMessages)                                                                                          //NOTIN815 //NOTIN816
        {                                                                                                         //NOTIN815 //NOTIN816
        theLog.debug("IOUtils.createBfileLocator: Created BFILE locator for Directory/File "                      //NOTIN815 //NOTIN816
                    + theOracleDirectory                                                                           //NOTIN815 //NOTIN816
                    + "/"                                                                                          //NOTIN815 //NOTIN816
                    + theFileName );                                                                                //NOTIN815 //NOTIN816
        }                                                                                                          //NOTIN815 //NOTIN816
      }                                                                                                            //NOTIN815 //NOTIN816
    catch (SQLException e)                                                                                         //NOTIN815 //NOTIN816
      {                                                                                                            //NOTIN815 //NOTIN816
      theLog.error("IOUtils.createBfileLocator: " + e.getMessage());                                                //NOTIN815 //NOTIN816
      throw new CSException("Unable to create oracle.sql.BFILE object :" + e.getMessage());                        //NOTIN815 //NOTIN816
      }                                                                                                            //NOTIN815 //NOTIN816
                                                                                                                   //NOTIN815 //NOTIN816
    return(newBfile);                                                                                              //NOTIN815 //NOTIN816
    }    
    ***/  
     //NOTIN815 //NOTIN816
}
